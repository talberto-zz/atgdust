...
public class GSATestUtils {
   ...
   * @return
   */
  public static Repository [] duplicateRepositories(GSARepository [] pRepositories, DataSource [] pDS) throws ServiceException {
    ...
    for (int i = 0 ; i < newReps.length; i++ ) {
      startRepository(pRepositories[i], pRepositories[i].getServiceConfiguration(), pRepositories[i].getNucleus(), newReps[i]);
    }
    return newReps;
  }
  public static Repository duplicateRepository(GSARepository pRepository,DataSource pDS) throws ServiceException{
   ...
   */
  public static Repository duplicateRepository(GSARepository pRepository,DataSource pDS,boolean pStart) throws ServiceException{
    Configuration c = pRepository.getServiceConfiguration();
    Nucleus n = pRepository.getNucleus();
    NucleusNameResolver r = new NucleusNameResolver(n, n,
        pRepository.getNameContext(), true);
    ...
    if(pRepository instanceof VersionRepository) {
      ...
      c.configureService(newRepository, r, ((VersionRepository)pRepository).getWrappedRepository());
    }
    else {
   ...
   */
  private static void startRepository(GSARepository pRepository, Configuration c, Nucleus n, GSARepository newRepository) throws ServiceException {
...
//        newRepository.copyFromOtherRepository(pRepository);
   ...
   * 
   * @param pRoot
   *          The root directory of the testing configpath
   * @param pRepositoryPath
   *          The Nucleus path of your testing repository
   * @param pDefinitionFiles
   *          Array of Nucleus paths to definition files
   * @param pJDBCProperties
   *          properties object containing JDBC connection information
   * @param pImportFile
   * @throws IOException
   * @throws Exception
  ...
  public  void initializeMinimalConfigpath(File pRoot,
      String pRepositoryPath, String[] pDefinitionFiles,
      Properties pJDBCProperties, String pCreateSQLAbsolutePath, String pDropSQLAbsolutePath, String[] pImportFile) throws IOException, Exception {
    initializeMinimalConfigpath(pRoot, pRepositoryPath, pDefinitionFiles, pJDBCProperties, pCreateSQLAbsolutePath, pDropSQLAbsolutePath, pImportFile, true);
  }
  ...
  public  void initializeMinimalConfigpath(File pRoot,
      String pRepositoryPath, String[] pDefinitionFiles,
      Properties pJDBCProperties, String pCreateSQLAbsolutePath, String pDropSQLAbsolutePath, String[] pImportFile, boolean pLogging) throws IOException, Exception {
   initializeMinimalConfigpath(pRoot, pRepositoryPath, pDefinitionFiles, pJDBCProperties, pCreateSQLAbsolutePath, pDropSQLAbsolutePath, pImportFile, pLogging, null, null);
  ...
  public  void initializeMinimalConfigpath(File pRoot,
      String pRepositoryPath, String[] pDefinitionFiles,
      Properties pJDBCProperties, String pCreateSQLAbsolutePath, String pDropSQLAbsolutePath, String[] pImportFile, boolean pLogging, String pFakeXADataSourceComponentName, String pJTDataSourceComponentName) throws IOException, Exception {
    if (pRepositoryPath != null)
      createRepositoryPropertiesFile(pRoot, pRepositoryPath,
          pDefinitionFiles, pCreateSQLAbsolutePath, pDropSQLAbsolutePath, pImportFile, pJTDataSourceComponentName);
    ...
    if(pJDBCProperties != null)
      GSATestUtils.createFakeXADataSource(pRoot, pJDBCProperties,pFakeXADataSourceComponentName);
    else 
      GSATestUtils.createFakeXADataSource(pRoot,DBUtils.getHSQLDBInMemoryDBConnection(), pFakeXADataSourceComponentName);
    if(pFakeXADataSourceComponentName == null && pJTDataSourceComponentName == null)
      DBUtils.createJTDataSource(pRoot);
    else 
      DBUtils.createJTDataSource(pRoot, pJTDataSourceComponentName, pFakeXADataSourceComponentName);
    createGlobal(pRoot);
   ...
   * 
   */
  public File createNucleus(File pRoot) throws IOException {
...
//---------------------------
  public  static File createFakeXADataSource(File pRoot,
      Properties pJDBCProperties, String pName) throws IOException {
    /*---- #
     * @version $Id:
    ...
    pJDBCProperties.put("transactionManager",
  ...
  public File createUserTransaction(File pRoot) throws IOException {
    ...
    return NucleusTestUtils.createProperties("UserTransaction",new File(pRoot,"/atg/dynamo/transaction"),"atg.dtm.UserTransactionImpl",props);
  }
   ...
   */
  public  File createRepositoryPropertiesFile(File pRoot,
      String pRepositoryPath, String[] pDefinitionFiles, String pCreateSQLAbsolutePath, String pDropSQLAbsolutePath, String[] pImportFiles, String pJTDataSourceName) throws IOException {
    /*
     * #
     * 
...
//    props.put("debugLevel", "7");
    ...
    if(mVersioned) props.putAll(additionalVersionProperties(pRoot,pRepositoryPath, repositoryName)); 
    return NucleusTestUtils
        .createProperties(repositoryName, root, clazz, props);
  }
  ...
  protected  Map<String, String> additionalVersionProperties(File pRoot, String pRepositoryPath, String pRepositoryName) throws IOException {
    ...
    GSATestUtils.getGSATestUtils()
        .createRepositoryPropertiesFile(
            ...
            new String[] { "/atg/adapter/version/versionmanager/versionManagerRepository.xml" }, null, null, null);
    // create the AssetFactory
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/AssetFactory", pRoot, "atg.versionmanager.impl.AssetFactoryRepositoryImpl", null);
    // create the AssetVersionFactory
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/AssetVersionFactory", pRoot, "atg.versionmanager.impl.AssetVersionFactoryRepositoryImpl", null);
    
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/BranchFactory", pRoot, "atg.versionmanager.impl.BranchFactoryRepositoryImpl", null);
    
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/DevelopmentLineFactory", pRoot, "atg.versionmanager.impl.DevelopmentLineFactoryRepositoryImpl", null);
    
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/SnapshotFactory", pRoot, "atg.versionmanager.impl.SnapshotFactoryRepositoryImpl", null);
        
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/WorkspaceFactory", pRoot, "atg.versionmanager.impl.WorkspaceFactoryRepositoryImpl", null);
    Properties props = new Properties();
    ...
    NucleusTestUtils
    .createProperties("/atg/adapter/version/versionmanager/VersionManagerService", pRoot, "atg.versionmanager.VersionManager", props);
 ...
 * @throws IOException
 */
public void copyToConfigpath(File pConfigRoot, String pString) throws FileNotFoundException, IOException {
 ...
 * @throws IOException
 */
public void copyToConfigpath(File pConfigRoot, String pString, String configPath) throws FileNotFoundException, IOException {
  ...
  public  File createVersionRepositoryPropertiesFile(File pRoot,
      String pRepositoryPath, String[] pDefinitionFiles) throws IOException {
    /*
     * #
     * 
     * @version $Id: //test/UnitTests/base/main/src/Java/atg/adapter/gsa/GSATestUtils.java#28 $$Change: 410369 $ $class=atg.adapter.gsa.GSARepository
...
//    props.put("debugLevel", "7");
 ...
 //   String index = null;
   ...
   * @throws SQLException
   */
  public  void createIDGeneratorTables(DBUtils db) throws SQLException {
    try {
      if(!db.isDB2())
      db
  ...
  public static void importFiles(VersionRepository pVerRep,
      String[] pImportFiles, String pWorkspaceName, boolean pDoWithoutTransaction,
      String pWorkspaceComment, boolean pCheckin) throws VersionException {
    ...
    if(TemplateParser.importFiles(pVerRep, pImportFiles, new PrintWriter(
        System.out), pDoWithoutTransaction, VersioningContextUtil.createVersioningContext(ws
        .getName(), pWorkspaceComment, pCheckin)) != 0)
